  ...
  return (
    <header className="bg-app-light flex justify-between items-center w-full fixed p-2">
      ...
      <div className="flex items-center gap-2">
        <Link className="app-btn" href="/">Download</Link>
        <Link className="app-btn" href="/">About</Link>
        <Link className="app-btn" href="/">Contact</Link>
        <Link className="app-btn" href="/">Donate</Link>
      </div>
    </header>
  )
...
const Hero = () => {
  ...
  return (
    <div className="grid grid-cols-12 items-center justify-center w-full gap-4 p-2">
      <div className="col-span-12 md:col-span-6 flex flex-col items-center">
        <div className="w-full text">
          ...
          ante eu cursus tincidunt, justo libero consequat tortor,
          at pellentesque erat velit nec libero. Vivamus vel nulla eu justo auctor laoreet.
        </div>
