...
export default function SubmitClaim() {
  ...
  const onHandleSelectTag = (index: number, value: string) => {
                ...
                <div className="sm:col-span-4">
                  ...
                  <div className="mt-2 ">
                    {referenceWebsites.map((website, index) => (
                      <div
                        key={index}
                        className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-green-600 sm:max-w-md  mt-2"
                      >
                ...
                <div className="col-span-full">
                  ...
                  <div className="mt-2 ring-black">
                    {Object.values(Tags).map((tag, index) => (
                      <Tag cursor={"pointer"} m={2} key={index}>
                        {" "}
                        {tag}{" "}
                      </Tag>
                    ))}
